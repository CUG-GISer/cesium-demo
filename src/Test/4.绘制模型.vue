      ...
      },
      {
        ...
        onselect: function () {
          const e = viewer.entities.add({
            position: Cesium.Cartesian3.fromDegrees(-122.1958, 46.1915),
            billboard: {
              image: "http://192.168.10.11:8888/cesium/gltf/facility.gif",
              heightReference: Cesium.HeightReference.CLAMP_TO_GROUND,
            },
          });
        ...
        onselect: function () {
          ...
          const e = viewer.entities.add({
            polygon: {
              ...
              material: "http://192.168.10.11:8888/cesium/gltf/Cesium_Logo_Color.jpg",
      ...
      },
      {
        ...
        onselect: function () {
          const e = viewer.entities.add({
            position: Cesium.Cartesian3.fromDegrees(-122.1958, 46.1915),
            model: {
              uri: "http://192.168.10.11:8888/cesium/gltf/Cesium_Man.glb",
              heightReference: Cesium.HeightReference.CLAMP_TO_GROUND,
